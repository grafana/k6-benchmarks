...
This repository contains the scripts used to benchmark k6 v0.42.0 on AWS EC2.

Please see the companion article ["Running large tests"](https://k6.io/docs/testing-guides/running-large-tests/) in our documentation for details.
...
![k6 iftop htop](./screenshots/3-terminals.png)
...
This setting disables the internal babel transpilation between ES6 to ES5 and inclusion of corejs library.
